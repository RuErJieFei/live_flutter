          ...
          children: [
            Card(
              ...
              shape:  RoundedRectangleBorder(
                ...
                side: BorderSide(color: Config.primaryColor, width: 2.0),
              ),
              child: TableCalendar(
                ...
                headerStyle:  HeaderStyle(
                  titleTextStyle:
                  TextStyle(color:Config.primaryColor, fontSize: 20.0),
                  ...
                  TextStyle(color: Config.primaryColor, fontSize: 16.0),
                ...
                daysOfWeekStyle: const DaysOfWeekStyle(
                  ...
                  weekendStyle: TextStyle(color:Config.primaryColor),
                ),
                // Calendar Dates styling
                calendarStyle: const CalendarStyle(
                  // Weekend dates color (Sat & Sun Column)
                  weekendTextStyle: TextStyle(color:Config.primaryColor),

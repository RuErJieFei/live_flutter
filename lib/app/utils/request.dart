...
class HttpResponseFormat {
  ...
  HttpResponseFormat(this.codeKey, this.dataKey, this.msgKey, this.successCodeValue,
      {this.tokenKey});
}
...
class Request {
  ...
  static Map<String, dynamic> myHeaders = {
    'userId': 511,
    'version': '',
    'deviceNum': 'deviceNum',
  ...
  void init(
    ...
    /// 初始化响应类型
    _responseFormat = responseFormat ?? HttpResponseFormat('code', 'data', 'msg', '1');
        ...
        try {
          ...
          if (response.data[_responseFormat.codeKey].toString() !=
            ...
            if (response.data is Map) {
              ...
              return json.decode(response.data[_responseFormat.dataKey].toString());
            }
          }
        } catch (e) {
          print(e.toString());
  ...
  Future<T> post<T>(
    ...
    return _request(path,
        method: 'post', params: params, data: data, isHasToken: isHasToken, headers: headers);
  }
}
